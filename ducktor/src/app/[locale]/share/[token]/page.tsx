    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-100 px-6 py-4">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-primary">Ducktor</span>
          </div>
          {isTranslated && (
            <div className="flex items-center gap-1.5 text-xs text-primary bg-[var(--color-primary-bg)] px-3 py-1 rounded-full">
      ...
      <main className="max-w-2xl mx-auto px-6 py-6">
        <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg text-xs text-amber-800">
          Read-only access · For medical professional use · Shared via Ducktor secure link
        </div>
        <IPSSummary ips={ips} />
      </main>
    </div>
