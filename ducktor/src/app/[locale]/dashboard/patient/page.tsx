    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-100 px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <span className="text-xl font-bold text-primary">Ducktor</span>
        ...
        <div className="mb-6">
          ...
          {!patient && (
            <div className="mt-3 p-4 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800">
              Completa tu perfil para usar Ducktor.{' '}
...
function DashCard({
  ...
  const bg: Record<string, string> = {
    blue: 'hover:border-[var(--color-border)]',
    green: 'hover:border-success',
    purple: 'hover:border-[var(--color-accent)]',
